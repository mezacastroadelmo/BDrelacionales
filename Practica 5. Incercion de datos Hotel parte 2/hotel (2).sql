...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-02-2026 a las 16:15:13
...
INSERT INTO `empleados` (`id_empleado`, `id_hotel`, `nombre`, `puesto`, `email`) VALUES
(1, 2, 'Pit Sahot', 'Portero', 'pit.sahot@gmail.com'),
(2, 3, 'Mac Donal', 'Recepcionista', 'mac.donal@gmail.com'),
(3, 1, 'Al', 'Aseador', 'Al.yancovik@gmail.com'),
(4, 3, 'Juan Lopez', 'Portero', 'juan.lopez@gmail.com'),
(5, 2, 'Batman Bin Suparman', 'Aseador ', 'batman.bin@gmail.com');
...
(1, 2, 616, 'Suite', 5800, 'Limpia'),
(2, 3, 1610, 'Estándar', 1500, 'Limpia'),
(3, 1, 13122, 'Deluxe', 3000, 'Limpia'),
(4, 2, 2149, 'Matrimonial', 4000, 'Limpia'),
(5, 3, 838, 'Presidencial', 9110, 'Limpia');
